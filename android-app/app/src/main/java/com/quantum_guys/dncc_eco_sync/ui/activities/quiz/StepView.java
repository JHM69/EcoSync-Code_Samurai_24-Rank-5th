...
public class StepView extends View {
    ...
    public static List<Boolean> stepAnsList = new ArrayList<>();
    ...
    public void go(int step, boolean animate, boolean correct) {
        stepAnsList.add(step, correct);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < stepSize; i++) {
            drawStep(canvas, i, circlesX[i], circlesY, stepAnsList.get(i));
        }
    ...
    private void drawStep(Canvas canvas, int step, int circleCenterX, int circleCenterY, boolean hoiche_naki) {
        ...
        if (isSelected && !isDone) {
            ...
            if (hoiche_naki) {
                ...
                canvas.drawCircle(circleCenterX, circleCenterY, doneCircleRadius, paint);
                drawUnCheckMark(canvas, circleCenterX, circleCenterY);
            }
